...
The CFI is ContextLint's flagship *experimental* signal. It asks: when the same
...
from contextlint.models import AnalyzerResult
from contextlint.utils.nlp import entity_set
