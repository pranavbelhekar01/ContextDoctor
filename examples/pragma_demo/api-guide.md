...
out of the secret rule with an inline pragma.

```
OPENAI_API_KEY=sk-EXAMPLEONLYdonotusethisvalue1234567890
```

Set the key as an environment variable before running the client.
