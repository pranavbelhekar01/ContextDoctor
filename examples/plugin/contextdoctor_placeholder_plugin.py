"""Example ContextDoctor plugin: flag unfinished / placeholder content.
...
Use it three ways:
  ...
  # ad-hoc, from the CLI
  contextdoctor analyze ./docs --plugin examples/plugin/contextdoctor_placeholder_plugin.py

  # via config (.contextdoctor.json)
  { "plugins": ["examples/plugin/contextdoctor_placeholder_plugin.py"] }
